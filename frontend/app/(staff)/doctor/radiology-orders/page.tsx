      ...
      <div className="flex justify-between items-end mb-6">
        <div>
          <h1 className="text-2xl font-bold text-slate-900 dark:text-white flex items-center gap-2">
            <Activity className="text-teal-600" /> Radiology Orders
          </h1>
          <p className="text-slate-500 dark:text-slate-400 mt-1">Manage radiology orders for your clinical practice.</p>
        </div>
      </div>
